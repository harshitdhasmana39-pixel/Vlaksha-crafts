            ...
            <div className="bg-red-50 border border-red-200 text-red-800 text-xs py-3 px-4 rounded-none font-sans">
              {error.includes('operation-not-allowed') ? (
                ...
                <div className="text-left space-y-3 font-sans">
                  <div className="font-bold text-sm text-red-900 flex items-center gap-1.5">
                    ⚠️ Firebase Unauthorized Domain
                  </div>
                  <p className="text-xs text-red-800 leading-relaxed">
                    The domain <strong>{window.location.hostname}</strong> is not registered as an Authorized Domain in your Firebase Console yet.
                  </p>
                  <div className="bg-white/60 p-3 border border-red-200/50 space-y-2 text-[11px] text-stone-700 leading-relaxed rounded-sm">
                    <p className="font-semibold text-[var(--theme-accent)]">How to allow Google Sign-In:</p>
                    <ol className="list-decimal list-inside space-y-1.5">
                      <li>Go to the <a href="https://console.firebase.google.com" target="_blank" rel="noreferrer" className="text-[var(--theme-primary)] underline font-bold hover:text-[var(--theme-accent)]">Firebase Console</a></li>
                      <li>Select your project <strong>vlaksha-crafts-27a0d</strong></li>
                    ...
                    <div className="p-2 bg-stone-100 font-mono text-[10px] break-all select-all border border-stone-200 rounded-sm text-center font-bold">
              ...
              ) : error.toLowerCase().includes('popup-closed-by-user') || error.toLowerCase().includes('popup') || error.toLowerCase().includes('closed') || error.toLowerCase().includes('cancelled') ? (
                <div className="text-left space-y-3">
                  <div className="font-bold text-sm text-red-900 flex items-center gap-1.5">
